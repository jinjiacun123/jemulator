...
void m_gpu_reset(uint32_t m_value, m_simplestation_state *m_simplestation)//[by jim] need
{
    (void) m_value;
...
void m_gpu_set_display_enabled(uint32_t m_value, m_simplestation_state *m_simplestation)//[by jim] need
{
    m_simplestation->m_gpu->m_display_disabled = ((m_value & 1) != 0);
}

void m_gpu_set_display_horizontal_range(uint32_t m_value, m_simplestation_state *m_simplestation)//[by jim] need
{
...
void m_gpu_set_display_vertical_range(uint32_t m_value, m_simplestation_state *m_simplestation)//[by jim] need
{
...
void m_gpu_set_display_mode(uint32_t m_value, m_simplestation_state *m_simplestation)//[by jim] need
{
